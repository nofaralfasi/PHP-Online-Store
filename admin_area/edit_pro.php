...
<form action="" method="post" enctype="multipart/form-data">
    <table align="center" width="795" border="2">
        ...
        <tr>
            ...
            <td><input type="file" name="product_image[]" multiple/><img src="product_images/<?php echo $pro_image[0]; ?>" width="60" height="60"/></td>
        </tr>
...
if (isset($_POST['update_product'])) {
    ...
    $update_product = "update products set product_cat='$product_cat',product_brand='$product_brand',product_title='$product_title',product_price='$product_price',product_desc='$product_desc',product_image='$pro_image', product_keywords='$product_keywords' where product_id='$update_id'";
